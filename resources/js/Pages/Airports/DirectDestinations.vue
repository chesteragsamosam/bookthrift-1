...
<div class="container pt-8">
    ...
    <div class="table p-4 my-4 align-middle border rounded">
        <tr>
            ...
            <td><Input v-model="params.departureAirportCode" type="text" id="departureAirportCode" class="uppercase" required placeholder="Code" /></td>
        </tr>
    </div>
    <div>
...
const fetchData = async () => {
    errors.value = []
    if (params.value.departureAirportCode == '') errors.value.push('Required')
